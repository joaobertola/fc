...
<!-- Pessoa Jurídica  -->
<form id="cadastroClientePJ" name="cadastroClientePJ">
    ...
    <div class="col-md-12">
      ...
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          <input type="text" id="razaoSocial" class="form-control form-required" placeholder="Razão Social">
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="form-row align-items-center">
    ...
    <div class="col-md-4">
      <div class="form-group">
        <button id="btnImportReceita" class="btn btn-block btn-secondary">Importar informações da Receita </button>
      </div>
    </div>
  </div>
  <div class="form-row align-items-center">
    ...
    <div class="col-md-12">
      <div class="form-group d-flex">
        <label>Subtituto Tributário:</label>
        <div class="custom-control custom-radio ml-2">
          <input class="custom-control-input" type="radio" id="customRadio2" name="customRadio" checked="">
          <label for="customRadio2" class="custom-control-label font-weight-normal">Sim</label>
        </div>
        <div class="custom-control custom-radio ml-2">
          <input class="custom-control-input" type="radio" id="customRadio3" name="customRadio">
          <label for="customRadio3" class="custom-control-label font-weight-normal">Não</label>
        </div>
      </div>
    </div>
  </div>
  <div class="form-row align-items-center">
    ...
    <div class="col-md-4">
      <div class="form-group d-flex">
        ...
        <div class="custom-control custom-radio ml-2">
          <input class="custom-control-input clienteIsento" type="radio" id="isento" name="isento" value="1" checked="">
          <label for="isento" class="custom-control-label font-weight-normal">Sim</label>
        </div>
        <div class="custom-control custom-radio ml-2">
          <input class="custom-control-input clienteIsento" type="radio" id="naoIsento" name="isento" value="0">
          <label for="naoIsento" class="custom-control-label font-weight-normal">Não</label>
        </div>
      </div>
    </div>
    <div class="col-md-8">
      <div class="form-group">
        <div class="input-group">
          <input type="text" name="inscricaoEstadual" id="inscricaoEstadual" class="form-control" placeholder="Inscrição Estadual" disabled value="ISENTO">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="col-md-6">
      <div class="form-group">
        <div class="input-group">
          ...
          <input type="text" class="form-control" placeholder="Inscrição SUFRAMA">
        </div>
      </div>
    </div>
    <!-- Inscrição Municipal  -->
    <div class="col-md-6">
      <div class="form-group">
        <div class="input-group">
          ...
          <input type="text" class="form-control" placeholder="Inscrição Municipal">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="col-md-6">
      <div class="form-group">
        <div class="input-group">
          ...
          <input type="text" class="form-control" placeholder="Data de Fundação">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="col-md-12">
      ...
      <div class="form-group">
        <div class="input-group">
          ...
          <input type="text" class="form-control" placeholder="Proprietário 1">
        </div>
      </div>
    </div>
    <div class="col-md-6">
      ...
      <div class="form-group">
        <div class="input-group">
          ...
          <input type="text" class="form-control telefone" placeholder="Telefone Sócio 1">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="col-md-12">
      ...
      <div class="form-group">
        <div class="input-group">
          ...
          <input type="text" class="form-control" placeholder="Proprietário 2">
        </div>
      </div>
    </div>
    <div class="col-md-6">
      ...
      <div class="form-group">
        <div class="input-group">
          ...
          <input type="text" class="form-control telefone" placeholder="Telefone Sócio 2">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="col-md-6">
      <div class="form-group">
        <div class="input-group">
          ...
          <input type="date" class="form-control date" placeholder="Data de Cadastro">
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="form-row align-items-center flex-row-reverse">
    ...
    <div class="col-md-2 mb-2">
      <button type="button" data-tipo="PJ" class="btn btn-block btn-success text-bold cadastraCliente">Salvar &nbsp; <i class="fas fa-save"></i></button>
    </div>
    <!-- Cancelar -->
    <div class="col-md-2 mb-2">
